...
<header class="bg-dark py-5">
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
          ...
          <p>"Memberikan ulasan makanan adalah cara terbaik untuk memberi tahu kami apa yang Anda sukai. 
            Beri tahu kami bagaimana kami dapat membuat pengalaman kuliner Anda lebih baik!"</p>
        </div>
      </div>
    </header>
    <!-- Section-->
